...
// import Arrow from '@/assets/images/common/link-arrow.svg'
      ...
      <div className='group cursor-pointer'>
        <div className='flex justify-end'>
          ...
          <div className='relative h-6 w-4 overflow-hidden'>
            <div className='flex'>
              {/* <Arrow className='slow-fade mt-2 h-4 w-4 transition-transform duration-500 group-hover:translate-x-150 group-hover:translate-y-m150' /> */}
              {/* <svg
